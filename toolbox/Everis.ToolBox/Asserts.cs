...
namespace Everis.ToolBox
{
    public static class Asserts
    {
        public static void isValidEnum<T>(T enumValue,
        ...
        public static void fileNotExists(string filePath,
            [CallerLineNumber] int sourceLineNumber = 0,
            [CallerMemberName] string memberName = "",
            [CallerFilePath] string sourceFilePath = "")
        {
            prv_stringIsNotEmpty(filePath, memberName, sourceFilePath, sourceLineNumber);
            prv_assert(File.Exists(filePath) == false, memberName, sourceFilePath, sourceLineNumber);
        }
